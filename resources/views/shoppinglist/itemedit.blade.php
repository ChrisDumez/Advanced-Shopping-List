...
<head>
    ...
    <title>Edit Item - Advanced Shopping List</title>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card mb-5">
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="bs-icon-xl bs-icon-circle bs-icon-primary bs-icon my-4" style="margin-left: -205px;margin-bottom: 0px;background: #FFA500;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-person">
                    ...
                    <div class="card mb-5">
                        <div class="card-body d-flex flex-column align-items-center">
                            <h1 style="margin-bottom: 26px;">Change Item</h1>
                            <form class="text-center" action="{{ url('/change-item/'.$item->id) }}" method="post" style="width: 282.333px;">
                            @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3"><input class="form-control" type="text" value="{{$item->item}}" name="item" placeholder="Item"></div>
                                ...
                                <div class="mb-3"><button class="btn btn-warning d-block w-100" type="submit">Apply Changes</button></div>
