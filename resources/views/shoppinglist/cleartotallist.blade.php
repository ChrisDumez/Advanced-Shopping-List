        ...
        <div class="container">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-6 col-xl-4">
                    ...
                    <div class="card mb-5">
                        <div class="card-body d-flex flex-column align-items-center">
                            <h1 style="margin-bottom: 26px;">Clear Collection</h1>

                            <h4>{{$username}}, Are you sure you want to clear the shopping list?</h4>

                            <a href="{{ url('/delete-purchaseitemdeleteAll') }}"><button class="btn btn-danger" type="button" >Clear Shopping List</button></a>
