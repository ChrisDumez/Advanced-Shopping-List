...
<head>
    ...
    <title>Registration - Advanced Shopping List</title>
    <link rel="stylesheet" href="{{ URL::asset('user_registration/bootstrap/css/bootstrap.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ URL::asset('user_registration/css/Login-Form-Basic-icons.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('user_registration/css/login-form-styles.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('user_registration/css/login-form.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('user_registration/css/styles.css') }}">
</head>
...
<body>
                    ...
                    <div class="card mb-5">
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            @csrf
                                ...
                                <a href="{{ url('/') }}" style="text-decoration: none;"><p class="text-muted">Back to Login Screen</p></a>
                            </form>
    ...
    <script src="{{ URL::asset('user_registration/bootstrap/js/bootstrap.min.js') }}"></script>
</body>
